...
public class SimpleMidiWriter
{
	...
	public static String saveToMidiFile(String Filename, ArrayList<Integer> pitches, ArrayList<Integer> durations)
	{
		Sequence s = null;
		try
		{
		...
		{
			int newPitch = pitches.get(i);
			int newDuration = DURATION[durations.get(i)];
